    ...
    if ("geolocation" in navigator) {
        navigator.geolocation.getCurrentPosition(
            ...
            (error) => {
                ...
                // We send nulls; if the user's organization has Geofencing strictly ON, 
                // the Backend API will deny them. If off, or if they are admin, they will pass.
        ...
        <div className="card p-6 mb-4">
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="relative">
              ...
              />
              <button onClick={() => setShow(!show)} className="absolute right-3 top-1/2 -translate-y-1/2 text-txt3 hover:text-txt2">
