  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        <button onClick={() => { onStatusFilterChange('VISITED'); onHotFilterChange(false); }} className={clsx('px-4 py-2 rounded-xl text-xs font-bold transition-all border shadow-sm', statusFilter === 'VISITED' ? 'bg-accent2 text-white border-accent2 scale-105' : 'bg-card text-txt2 border-border hover:bg-bg3')}>Site Visit Done</button>
