...
class CallLogSerializer(serializers.Serializer):
    ...
    outcome = serializers.ChoiceField(choices=['INTERESTED', 'CALLBACK', 'LOST', 'CALLED', 'NOT_ANSWERED'], required=True)
    ...
    def validate(self, data):
        ...
        if outcome not in ('LOST',) and not data.get('next_call_at'):
